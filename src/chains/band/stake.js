...
MsgDelegate.prototype.type = Config.band.tx.delegate.prefix;
...
MsgUndelegate.prototype.type = Config.band.tx.undelegate.prefix;
...
MsgBeginRedelegate.prototype.type = Config.band.tx.beginRedelegate.prefix;
MsgBeginRedelegate.prototype.GetSignBytes = function () {
  let msg = {
    ...
    validator_src_address: BECH32.encode(
      Config.band.bech32.valAddr,
      this.ValidatorSrcAddress
    ),
    validator_dst_address: BECH32.encode(
      Config.band.bech32.valAddr,
...
MsgBeginRedelegate.prototype.GetDisplayContent = function () {
  ...
  let validatorSrcAddress = BECH32.encode(
    Config.band.bech32.valAddr,
    this.ValidatorSrcAddress
  );
  let validatorDstAddress = BECH32.encode(
    Config.band.bech32.valAddr,
    this.ValidatorDstAddress
  );
