...
const MsgWithdrawValidatorCommission =
  Root.cosmos.MsgWithdrawValidatorCommission;

MsgSetWithdrawAddress.prototype.type = Config.band.tx.setWithdrawAddress.prefix;
MsgSetWithdrawAddress.prototype.GetSignBytes = function () {
  let msg = {
    delegator_address: BECH32.encode(
      Config.band.bech32.accAddr,
      this.DelegatorAddress
    ),
    withdraw_address: BECH32.encode(
      Config.band.bech32.accAddr,
...
MsgSetWithdrawAddress.prototype.toJSON = function () {
  let delegator_addr = BECH32.encode(
    Config.band.bech32.accAddr,
    this.DelegatorAddress
  );
  let withdraw_addr = BECH32.encode(
    Config.band.bech32.accAddr,
    this.WithdrawAddress
  );
  return {
...
MsgWithdrawDelegatorReward.prototype.type =
  Config.band.tx.withdrawDelegatorReward.prefix;
...
MsgWithdrawDelegatorReward.prototype.toJSON = function () {
  let delegatorAddr = BECH32.encode(
    Config.band.bech32.accAddr,
    this.DelegatorAddress
  );
  let validatorAddress = BECH32.encode(
    Config.band.bech32.accAddr,
    this.ValidatorAddress
  );
  return {
...
MsgWithdrawDelegatorReward.prototype.GetDisplayContent = function () {
  let delegatorAddress = BECH32.encode(
    Config.band.bech32.accAddr,
    this.DelegatorAddress
  );
  let validatorAddress = BECH32.encode(
...
MsgWithdrawValidatorCommission.prototype.type =
  Config.band.tx.withdrawValidatorCommission.prefix;
