...
MsgDeposit.prototype.type = Config.band.tx.deposit.prefix;
MsgDeposit.prototype.GetSignBytes = function () {
  let depositor = BECH32.encode(Config.band.bech32.accAddr, this.depositor);
  let signMsg = {
...
MsgVote.prototype.type = Config.band.tx.vote.prefix;
MsgVote.prototype.GetSignBytes = function () {
  let voter = BECH32.encode(Config.band.bech32.accAddr, this.voter);
  let signMsg = {
    proposal_id: `${this.proposalID}`,
    voter: voter,
